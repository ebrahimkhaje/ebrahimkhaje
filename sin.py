...
print(txt)
print(green+f"channel_Rubika:{darkblue}      @channel_mster_Gad")
print(green+f"......................{red}[ebrahim]{red}[null]{green}............................")

print(green+f"                    [@ m s t e r_G‌ a‌ d]  ")
print("اوث اکانتتو بزن")
a =input("                    your_auth :")
print("لینک پست مورد نظرتو بزن")
m =input("                your post link  :")
x =input("                your time.sleep(0,1،2‌،3،4و....):")
bot = Robot_Rubika(a)
        ...
        for chat in messages_channell:
        					try:
        					    ...
        					    for linkes in link_Group:
        					        ...
        					        res1 = bot.getMessagesInfo(k, [m])
        					        for n in res1:
        					            seen = n['count_seen']
        					            print(green+f" \n [forward mag] : [{randomli}] \n {blue}[name gap] : [1{info}] \n {yellow}[forward] : [{sum}] \n {blue}[momber group] : [{momber}] \n {red}[seen] :[{seen}] \n {yellow}!........................{red}[ebrahim]{red}[null]{yellow}.......................!{darkblue}\n!..........................{green}[@mster_G‌a‌d]{darkblue}.........................!")
